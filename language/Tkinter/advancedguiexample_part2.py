...
monthspinner=tkinter.Spinbox(dateframe,width=5,values=tuple(range(1,13)))
monthspinner.grid(row=1,column=1)


yearspinner=tkinter.Spinbox(dateframe,width=5,from_=0000,to=9999) # alternative to values
